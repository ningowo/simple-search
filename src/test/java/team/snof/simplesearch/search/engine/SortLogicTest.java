...
class SortLogicTest {
    ...
    void sortDoc(){
        ...
        wordToFreq.put("test",1);wordToFreq.put("namomo",2);
        List<DocInfo>  index1 = new ArrayList<>();
        List<DocInfo>  index2 = new ArrayList<>();
        index1.add(new DocInfo(1l,3l,new BigDecimal(0.2)));
        index1.add(new DocInfo(2l,4l,new BigDecimal(0.6)));
        index2.add(new DocInfo(1l,3l,new BigDecimal(0.4)));
        index2.add(new DocInfo(2l,4l,new BigDecimal(0.3)));
